...
<div class="flex items-center justify-center flex-col gap-6 w-11/12">
	...
	<img src={author.data.image || dummyProfile} alt={author.data.name + 'cover'} class="w-2/3" />
	<div class="flex items-center justify-around w-11/12 shadow-xl shadow-black p-4 flex-wrap">
		<div class="flex w-48 items-center justify-between">
			<p>Born:</p>
			<p class="text-xl">{author.data.born}</p>
		</div>
		<div class="flex w-48 items-center justify-between">
			<p>Died:</p>
			<p class="text-xl">{author.data.died}</p>
		</div>
		<div class="flex w-48 items-center justify-between">
			<p>Birth Place:</p>
			<p class="text-xl">{author.data.birth_place}</p>
		</div>
	</div>
	<div class="flex items-center justify-around w-11/12 shadow-xl shadow-black p-4 flex-wrap">
